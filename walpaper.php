...
<div class="container-fluid" style="background-image: url(image/fond.jfif); background-size: cover;">
  <div class="row">
    ...
    <div class="col-sm-12 col-md-3 col-lg-3" style="height: 300px; " id="scroll_music">
        <img src="image/walpaper/courbe.jpg" alt="casque" width="200px" height="200px" id="playlist" >
    ...
    <div class="col-sm-12 col-md-3 col-lg-3" style="height: 300px; ">
      <img src="image/walpaper/matrix.jpg" alt="casque" width="200px" height="200px">
    ...
    <div class="col-sm-12 col-md-3 col-lg-3" style="height: 300px; ">
      <img src="image/walpaper/virus.png" alt="casque" width="200px" height="200px" >
    ...
    <div class="col-sm-12 col-md-3 col-lg-3" style="height: 300px; ">
      <img src="image/walpaper/multi-screen.jpg" alt="casque" width="200px" height="200px" >
    ...
    <div class="col-sm-12 col-md-3 col-lg-3" style="height: 300px; margin-top: 50px; ">
      <img src="image/walpaper/i_can.jpg" alt="casque" width="200px" height="200px" ">
    ...
    <div class="col-sm-12 col-md-3 col-lg-3" style="height: 300px;margin-top: 50px;">
      <img src="image/walpaper/masque.jpg" alt="casque" width="200px" height="200px">
    ...
    <div class="col-sm-12 col-md-3 col-lg-3" style="height: 300px;margin-top: 50px; ">
      <img src="image/walpaper/kali.jpg" alt="casque" width="200px" height="200px">
    ...
    <div class="col-sm-12 col-md-3 col-lg-3" style="height: 300px;margin-top: 50px; ">
      <img src="image/walpaper/failure.png" alt="casque" width="200px" height="200px" >
...
if(isset($_SESSION['user'])) {
    ...
    echo '<button type="button" class="btn btn-outline-primary"><a href="telecharger_image.php?id='. $id . ' " style="text-decoration: none;">Download <i class="fa fa-download"></i></a></button>';
} else {
